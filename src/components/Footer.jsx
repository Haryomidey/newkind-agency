...
const Footer = () => {
    return (
        <div className='bg-[#4f4aec] w-full px-5 sm:px-20 pt-10 text-white'>
            <div className='min-h-[300px] flex justify-between flex-wrap gap-x-5 gap-y-10 text-xs sm:text-sm'>
                ...
                <ul className='font-normal flex flex-col gap-4'>
                    <li className='font-medium mb-2'>Services</li>
                    <li><Link>Strategy</Link></li>
                    <li><Link>Branding</Link></li>
                    <li><Link>Branding Engagement</Link></li>
                    <li><Link>Content Marketing & Digital</Link></li>
                </ul>
                <ul className='font-normal flex flex-col gap-4'>
                    <li className='font-medium mb-2'>About</li>
                    <li><Link>Our Story</Link></li>
                    <li><Link>Team</Link></li>
                    <li><Link>Careers</Link></li>
                </ul>
                <ul className='flex flex-col gap-4'>
                    <li className='font-medium mb-2'>Follow Us</li>
            ...
            <div className='w-full flex items-center justify-between flex-wrap gap-4 pb-5 text-sm'>
                ...
                <p className='text-[#c9c9c9e5] text-[10px]'>Copyright <span>&copy;</span> {new Date().getFullYear()} NewKindred. All rights reserved</p>
            </div>
        </div>
    )
}
